...
runCommand(['composer', 'archive', '--format=zip', '--dir=dist', '--file=a2a-php-sdk'], $root);
$source = $temporary.'/package';
runCommand(['unzip', '-q', $root.'/dist/a2a-php-sdk.zip', '-d', $source], $root);
$allowed = ['composer.json', 'README.md', 'LICENSE', 'CHANGELOG.md', 'src', 'generated', 'proto'];
...
foreach (['composer.json', 'README.md', 'LICENSE', 'src/Client/Client.php', 'generated/Lf/A2a/V1/Task.php'] as $file) {
...
$consumer = [
    ...
    'require' => ['vbcherepanov/a2a-php-sdk' => '1.0.0'],
    'repositories' => [[
        'type' => 'path',
        'url' => $source,
        'options' => ['symlink' => false, 'versions' => ['vbcherepanov/a2a-php-sdk' => '1.0.0']],
    ]],
...
if (file_put_contents($root.'/dist/SHA256SUMS', hash_file('sha256', $root.'/dist/a2a-php-sdk.zip')."  a2a-php-sdk.zip\n") === false) {
